...
var specs = [ // TODO: ??? hardcoded
	...
	"Прилож. моб. платф.","Распред. инф. сист.","Сист. прогр. в .NET","ЯиС искусст. интел.","ГИС-техн. в прил.","Проект. системы ИБ","ИТ в Инт. маркет.","Методология НИР","ВИНР","ГС с ARM-архитект","ОКРПО"
];
